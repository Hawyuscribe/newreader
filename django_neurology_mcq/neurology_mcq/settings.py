...
INSTALLED_APPS = [
    ...
    'django_celery_results',  # Add django-celery-results for task result storage
...
if redis_url.startswith('rediss://'):
    ...
    CELERY_RESULT_BACKEND = 'django-db'  # Use Django database for result storage to avoid Redis SSL issues
    CELERY_BROKER_USE_SSL = {
        'ssl_cert_reqs': ssl.CERT_NONE
    }
    # No need for CELERY_REDIS_BACKEND_USE_SSL since we're using django-db for results
else:
    # Local development without SSL
    CELERY_BROKER_URL = redis_url
    CELERY_RESULT_BACKEND = 'django-db'  # Use Django database for result storage
