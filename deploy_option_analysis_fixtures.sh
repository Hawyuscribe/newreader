...
FIXTURE_FILE="rere_option_analysis_fixtures.json"
...
# Copy the fixture file to Heroku's temp directory
cat $FIXTURE_FILE | heroku run "cat > /tmp/$FIXTURE_FILE" --app $APP_NAME
